            ...
            <div className="row">
                ...
                <div className="card">
                    ...
                    <h5 className="text-center ">Free</h5>
                        <h1 className="text-center">$0<span className="text">/month</span></h1>
                        <hr/>
                        <ul className="fa-ul">
                          ...
                          <div className="button container"><a href='#'className='a'>click</a></div>
                        </div>
                  </div>
                </div>
                <div className="col-4">
                <div className="card" >
                    <div className=" container">
                    <h5 className="text-center ">Plus</h5>
                        <h1 className="text-center">$9<span className="text">/month</span></h1>
                        <hr/>
                        <ul className="fa-ul">
              ...
              <li className="text-muted"><span className="fa-li"><i className="fas fa-times"></i></span>Monthly Status
                ...
                <div className="card" >
                    ...
                    <h5 className="text-center ">Pro</h5>
                        <h1 className="text-center">$49<span className="text">/month</span></h1>
                        <hr/>
                        <ul className="fa-ul">
